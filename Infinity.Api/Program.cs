...
app.UseCors(builder =>
{
    builder.AllowAnyOrigin(); // Permitir solicita��es de qualquer origem
    builder.AllowAnyMethod(); // Permitir solicita��es de qualquer m�todo (GET, POST, etc.)
    builder.AllowAnyHeader(); // Permitir solicita��es de qualquer cabe�alho
});
